...
export class BusinessContentUtils {
   ...
   *
   * Delegates to the site-wide rule in `@/lib/slug` — article anchor ids are
   * generated by the same function, and two slug implementations that disagree
   * produce links that point at nothing.
   */
