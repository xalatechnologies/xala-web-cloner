...
role: "IT-leder"
readingMinutes: 3
cover: "/images/blog/public-360-og-fagsystem-snakker-ikke.webp"
draft: false
lang: no
tag: "IT-leder"
keywords:
...
[Prinsipp 5](https://www.digdir.no/digital-samhandling/prinsipp-5-del-og-gjenbruk-losninger/1062) er å bruke 360 og fagsystemet dere allerede har. Ikke å lage et tredje sted å journalføre.
...
Digdir: «Mange av saksbehandlingssystemene inneholder støtte for journalføring og arkivering og kalles gjerne sak- og arkivsystemer. Det finnes også mange saksbehandlingssystem tilpasset spesifikke områder (for eksempel barnevern) som gjerne kalles fagsystemer.»
...
Journalplikt gjelder. [Arkivforskrifta](https://lovdata.no/dokument/SF/forskrift/2025-12-17-2647) trådte i kraft 1. januar 2026, jamfør § 52.

[§ 14](https://lovdata.no/dokument/SF/forskrift/2025-12-17-2647/%C2%A714): organet skal føre journal for å legge til rette for offentlig innsyn. I journalen skal organet registrere inngående og utgående dokument som etter offentleglova § 4 er saksdokument, dersom de er eller blir saksbehandlet og har verdi som stadfesting.

[§ 15](https://lovdata.no/dokument/SF/forskrift/2025-12-17-2647/%C2%A715): metadata skal registreres løpende. Unikt kjennetegn, kontekst, tittel, avsender eller mottaker, dato, og tidspunktet for registreringen.

[Nasjonalarkivet](https://www.nasjonalarkivet.no/offentlig-forvaltning/regelverk-og-standarder/noark/noark-hva-na/) skriver at journalføringsplikten videreføres, og at kravet til Noark-godkjente system faller bort. «Det er ikke nødvendig å integrere et fagsystem mot en Noark arkivkjerne for å oppfylle kravene til arkiv og journalføring.» Hvilken løsning dere velger, bør baseres på en behovs- og risikoanalyse. Kommunen beslutter.

## Hva eFormidling er til

eFormidling er fellesløsningen for å sende og motta som del av saksbehandling. Digdir: dokumentene som sendes og mottas, skal kunne knyttes til saken automatisk. «eFormidling kan også brukes for å legge til rette for (del-)automatisert saksbehandling.»

Det er kanalen. Bruk [eFormidling](https://docs.digdir.no/docs/eFormidling/Funksjonalitet/saksbehandling). Ikke bygg et privat postløp ved siden av.
...
Nei. Journalplikt gjelder. § 14 og § 15 sier hva som skal inn, og hvilke metadata som skal registreres løpende.

**Er dette det samme som 360 mot bevillingsportalen?**
