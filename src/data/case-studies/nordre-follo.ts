  ...
  translations: {
    no: {
      ...
      technologies: {
        ...
        databases: ['SQL Server'],
        cloud: ['Azure'],
        identity: ['Autentiseringstjenester', 'Rollestyrt tilgangskontroll'],
        integrations: ['APIs', 'Kommunale systemintegrasjoner'],
        devops: ['Testing og validering', 'Driftsstøtte', 'Overvåking og driftsklarhet'],
      },
    },
    ar: {
