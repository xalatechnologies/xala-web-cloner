        ...
        <TableBody>
          {services?.map((service) => (
            <TableRow key={service.id} className="border-gray-700 hover:bg-gray-800/50">
              <TableCell className="font-chakra text-white">{service.title}</TableCell>
              <TableCell className="font-chakra text-white max-w-md truncate">{service.description}</TableCell>
              <TableCell className="font-chakra text-white">{service.language}</TableCell>
              <TableCell className="font-chakra text-white">{service.sort_order}</TableCell>
              <TableCell className="font-chakra text-white">
                {service.featured ? (
