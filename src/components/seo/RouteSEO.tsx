 ...
 *
 * Four routes manage their own <Helmet> because their metadata depends on
 * content this component cannot see. Those are skipped rather than overridden,
 * so no page emits two titles or two canonicals.
 */
const RouteSEO = () => {
  ...
  if (rule.selfManaged) return null;

  return (
    <SEO
      pageId={rule.pageId}
      language={normalizeLanguage(i18n.language)}
      canonicalUrl={canonicalFor(pathname)}
